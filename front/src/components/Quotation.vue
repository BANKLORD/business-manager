            ...
            <v-list-item class="d-block">
              <v-list-item-title>
                <v-switch
                  ...
                  label="Basculer l'en-tête/Pied de page du devis"
                >
                </v-switch>
              </v-list-item-title>
            </v-list-item>
...
export default {
  ...
  methods: {
    ...
    async downloadQuotation() {
      await pdfMake.createPdf(this.invoiceData).download(`DEVIS-2022.${this.sale.count}.pdf`);
    },
    async generatePDF(){
    ...
    generatePriceToLetters() {
      ...
      this.invoiceData.content.push([
        { text: 'Arrêtée la présente devis à la somme de: \n', bold: true, fontSize: '10' },
    ...
    async generateQuotation() {
      ...
      this.invoiceData = Object.assign({}, this.defaultInvoiceData);
      this.invoiceData.info.title = `DEVIS-2022.${this.sale.count}`;
